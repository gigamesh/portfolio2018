const portfolioItems = [
  ...
  },
  {
    ...
    text:
      "RadicalxChange is a nonprofit organization founded by E. Glen Weyl, economist and principle researcher at Microsoft. I assisted in launching the website (Polymer and Firebase), adding features and design upgrades to the main page, and coding a markdown blog editor with React.",
  ...
  },
  {
    ...
    text:
      "Aud.io is a social network for connecting musicians and recording studios. Made with MongoDB, Node, React, Redux, Redux-saga, Material-UI & styled-components. Includes user registration with password encryption, form validation, live search, lazy-loaded images, and mobile-responsive CSS.",
  ...
  },
  {
    ...
    text:
      "Website for my music alter-ego. Built using javascript & jquery. Fully mobile-responsive.",
  ...
  },
  {
    ...
    text:
      "Calculator with scientific notation, built with javascript & jquery.",
